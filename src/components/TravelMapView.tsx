...
export const TravelMapView: React.FC<TravelMapViewProps> = ({
  ...
  return (
    <div className="relative w-full h-full bg-slate-100 overflow-hidden flex flex-col">
      ...
      <div className="absolute top-3 left-3 z-20 flex items-center space-x-1 bg-white/95 backdrop-blur-md p-1.5 rounded-xl border border-slate-200 shadow-md text-slate-800">
        <div className="flex items-center px-2 py-1 text-xs text-slate-500 border-r border-slate-200 gap-1 font-medium">
        ...
        <button
          type="button"
          onClick={() => setMapTileStyle('google_streets')}
      ...
      <div className="absolute bottom-6 right-4 z-20 flex flex-col space-y-2">
        ...
        <button
          ...
          className="p-2.5 bg-white hover:bg-slate-50 text-slate-800 rounded-xl shadow-lg border border-slate-200 transition flex items-center justify-center backdrop-blur-sm cursor-pointer group"
        >
